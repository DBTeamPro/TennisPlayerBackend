SELECT *
FROM	
	(SELECT SUBSTRING('G', 1) AS level,

			ROUND(
		    SUM(CASE WHEN H_TB.hand = 'L' THEN 1 END)/
		    (SUM(CASE WHEN H_TB.hand = 'L' THEN 1 END)+
		    SUM(CASE WHEN H_TB.hand = 'R' THEN 1 END)), 2) AS rate_of_left_hand
	FROM 
	...
	(SELECT ROUND(
		    ...
		    (SUM(CASE WHEN M_TB.winner_hand = 'L' THEN 1 END)+
		    SUM(CASE WHEN M_TB.loser_hand = 'L' THEN 1 END)), 2) AS win_rate,

			ROUND(
		    (SUM(CASE WHEN M_TB.winner_hand = 'L' THEN M_TB.winner_rank END)+
		    SUM(CASE WHEN M_TB.loser_hand = 'L' THEN M_TB.loser_rank END))/
		    (SUM(CASE WHEN M_TB.winner_hand = 'L' THEN 1 END)+
		    SUM(CASE WHEN M_TB.loser_hand = 'L' THEN 1 END)), 2) AS avg_rank
	FROM 
